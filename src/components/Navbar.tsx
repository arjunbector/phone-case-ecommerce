...
const Navbar = async () => {
  ...
  // };
  return (
    <nav className="sticky z-[100] h-14 inset-x-0 top-0 w-full border-b border-gray-200 dark:border-gray-500 bg-white/75 dark:bg-slate-900/75 backdrop-blur-lg transition-all">
      <MaxWidthWrapper>
